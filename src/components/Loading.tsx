...
const Loading: React.FC<LoadingProps> = ({ message = 'Loading...' }) => {
  return (
    <div className="flex flex-col items-center justify-center p-16 min-h-[400px] bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-100">
